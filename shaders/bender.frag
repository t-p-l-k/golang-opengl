...
vec4 mainImage(in vec2 fragCoord)
{
    ...
    vec3 ro2, rd2; generateRay( ro2, rd2, po, ta, fragCoord.xy+vec2(3.0,0.0) );
    vec3 ro3, rd3; generateRay( ro3, rd3, po, ta, fragCoord.xy+vec2(0.0,3.0) );
...
void main() {
    outputColor = mainImage(gl_FragCoord.xy);
}
